...
val teishokuList = listOf(
    ...
    Menu("焼き魚定食", 850,"塩焼きにサラダ、ご飯とお味噌汁が付きます。"),
    Menu("焼肉定食", 950,"特製タレの焼肉にサラダ、ご飯とお味噌汁が付きます。"),
)

val curryList = listOf(
    Menu("ビーフカレー", 520,"特製スパイスをきかせた国産ビーフ100%のカレーです。"),
    Menu("ポークカレー", 420,"特製スパイスをきかせた国産ビーフ100%のカレーです。"),
    ...
    Menu("から揚げカレー", 540,"特製スパイスをきかせたカレーに若鶏の唐揚げをトッピングです。"),
)